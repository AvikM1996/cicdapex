...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(225727636105318719)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(225728723458318725)
,p_plug_name=>'My Workflows - Smart Filters'
,p_parent_plug_id=>wwv_flow_imp.id(225727636105318719)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>3371237801798025892
,p_plug_display_sequence=>10
,p_plug_display_point=>'SMART_FILTERS'
,p_plug_source_type=>'NATIVE_SMART_FILTERS'
,p_filtered_region_id=>wwv_flow_imp.id(225728843631318725)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(225728843631318725)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(225734578947318754)
,p_name=>'WORKFLOW_ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(225735045103318756)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(225735549467318758)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(225736093205318760)
,p_name=>'TITLE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(225736587713318762)
,p_name=>'INITIATOR'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(225737018215318763)
,p_name=>'STATE_CODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(225737517227318765)
,p_name=>'CREATED_ON'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(225738069518318767)
,p_name=>'CREATED_AGO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(225738570174318768)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(225739010963318770)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(225739502469318772)
,p_name=>'BADGE_TEXT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(225740004345318774)
,p_name=>'BADGE_STATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(225728343593318722)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(225729294472318728)
,p_name=>'P5_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(225728723458318725)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(225729646896318730)
,p_name=>'P5_TYPE'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(225730034072318732)
,p_name=>'P5_STATE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(225728723458318725)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(225730725836318736)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(225731116622318738)
,p_name=>'P5_INITIATOR'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(225728723458318725)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(225731523342318740)
,p_name=>'P5_INITIATED'
...
,p_lov=>'.'||wwv_flow_imp.id(225731636539318740)||'.'
,p_item_template_options=>'#DEFAULT#'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'manual_entry', 'N',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(225741551048318781)
,p_name=>'P5_SORT_BY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(225728843631318725)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(225744720727318794)
,p_name=>'Refresh - My Workflows - Report'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(225728843631318725)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosecanceldialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(225745115776318796)
,p_event_id=>wwv_flow_imp.id(225744720727318794)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(225728843631318725)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(225745633541318798)
,p_event_id=>wwv_flow_imp.id(225744720727318794)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(225728723458318725)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(225741930735318783)
,p_name=>'Terminate'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(225742283774318784)
,p_event_id=>wwv_flow_imp.id(225741930735318783)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P5_WORKFLOW_ID'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(225742789855318786)
,p_event_id=>wwv_flow_imp.id(225741930735318783)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_attribute_02=>'P5_WORKFLOW_ID'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(225743213344318788)
,p_event_id=>wwv_flow_imp.id(225741930735318783)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(225743771823318790)
,p_event_id=>wwv_flow_imp.id(225741930735318783)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(225744241294318792)
,p_event_id=>wwv_flow_imp.id(225741930735318783)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_component_action(
 p_id=>wwv_flow_imp.id(225740562240318776)
,p_region_id=>wwv_flow_imp.id(225728843631318725)
...
wwv_flow_imp_page.create_component_action(
 p_id=>wwv_flow_imp.id(225741069772318778)
,p_region_id=>wwv_flow_imp.id(225728843631318725)
